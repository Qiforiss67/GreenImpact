        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">GreenImpact</h3>
                <p className="text-sm opacity-75">SDG Platform</p>
              </div>
            </div>
            <p className="text-gray-300 mb-4 ml-14">
              Empowering individuals to make a positive impact on the world through sustainable development goals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="text-gray-300 hover:text-white transition-colors">About SDGs</a></li>
